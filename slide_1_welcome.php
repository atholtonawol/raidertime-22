...
<style>
  body {
    ...
    background-image: url('https://github.com/atholtonawol/raidertime-22/blob/main/assets/image/atholton_building_updated_color_crop2.jpg?raw=true');
    ...
    <body>
      ...
      <div class="row">
        <div class="col-9">
          <h1 class="display-1"><strong>Atholton High School</strong></h1>
            <h2 class="display-2"><strong>Raider Time Signup</strong></h2>
        </div>
    ...
    <div class="container-fluid">
      ...
      <a class = "nav-link" href ="slide_9_faq.html">FAQs</a>
      </div> 
    </div>
